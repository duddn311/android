...
public class CourseListAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        final View v = View.inflate(context, R.layout.course, null); //뷰 생성
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!alreadyIn(courseIDList, courseList.get(i).getCourseID())) {
                    ...
                    AddRequest addRequest = new AddRequest(userID,courseList.get(i).getCourseID()+"" ,responseListener);  //실질적으로 접속 할 수 있도록 생성자를 통해 객체를 만든다.
                    RequestQueue queue = Volley.newRequestQueue(parent.getActivity());
                    queue.add(addRequest); //큐에 추가
                }
            }
        });
        return v;
